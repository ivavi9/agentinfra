...
class VaultSecretsManager:
    def __init__(self):
        self.vault_url = os.getenv("VAULT_ADDR", "http://vault.default.svc.cluster.local:8200")
    ...
    def _login_kubernetes(self):
        ...
        if not os.path.exists(self.token_path):
            raise FileNotFoundError(f"K8s ServiceAccount token not found at {self.token_path}. Ensure SA is mounted.")
