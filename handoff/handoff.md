...
- **Model Context Protocol (MCP) AWS S3 Tools**: Implemented FastMCP JSON-RPC 2.0 server ([mcp_s3_server.py](file:///Users/avikaushik/agentinfra/app/mcp_s3_server.py)) exposing keyless S3 tools (`s3_discover_landing_bucket`, `s3_list_raw_assets`, `s3_read_json_records`), client adapter ([mcp_client.py](file:///Users/avikaushik/agentinfra/app/mcp_client.py)), and test suite ([test_mcp_s3_server.py](file:///Users/avikaushik/agentinfra/tests/test_mcp_s3_server.py) — 23/23 tests passing).
